...
const Game = {
  ...
  selectCiv(civId) {
    ...
    // Inicializar mapa de Althoria
    if (typeof AlthoriаMap !== 'undefined') AlthoriаMap.assignZones(this.state);
  ...
  buildGranary() {
    const s = this.state;
    if (s.resources.wood < 100) { Systems.Log.add(s, '⚠️ Faltan 100🪵 para graneros.', 'warn'); }
    else {
