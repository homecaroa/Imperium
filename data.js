...
const MILITARY_UNITS = {
  levas:             {name:'Levas',             icon:'🪓',category:'infantry',      cost:{gold:20,iron:0},        upkeep:0.2,strength:8,  count:50,terrainBonus:{plains:1.0,hills:0.9,forest:0.85,mountains:0.7}, vsBonus:{infantry:1.0,cavalry:0.7,ranged:1.1,siege:1.2},  description:'Campesinos armados. Baratos pero débiles.',buildTurns:1},
  infanteria:        {name:'Infantería',        icon:'⚔', category:'infantry',      cost:{gold:60,iron:20},       upkeep:0.5,strength:20, count:40,terrainBonus:{plains:1.0,hills:1.0,forest:0.9,mountains:0.8},  vsBonus:{infantry:1.0,cavalry:0.9,ranged:1.15,siege:1.3}, description:'Soldado entrenado. Versátil.',buildTurns:1},
  legionarios:       {name:'Legionarios',       icon:'🛡',category:'heavy_infantry', cost:{gold:100,iron:40},      upkeep:0.9,strength:35, count:30,terrainBonus:{plains:1.2,hills:1.0,forest:0.75,mountains:0.7},vsBonus:{infantry:1.3,cavalry:1.1,ranged:1.2,siege:1.4},  description:'Élite pesada. Invencibles en campo abierto.',buildTurns:2,requires:['standing_army']},
  caballeria:        {name:'Caballería',        icon:'🐴',category:'cavalry',        cost:{gold:80,iron:15},       upkeep:0.8,strength:28, count:25,terrainBonus:{plains:1.4,hills:0.8,forest:0.5,mountains:0.3}, vsBonus:{infantry:1.3,cavalry:1.0,ranged:1.5,siege:0.8},  description:'Rápida e impactante. Domina las llanuras.',buildTurns:2},
  caballeria_pesada: {name:'Cab. Pesada',       icon:'🏇',category:'heavy_cavalry',  cost:{gold:150,iron:35},      upkeep:1.2,strength:45, count:20,terrainBonus:{plains:1.5,hills:0.7,forest:0.3,mountains:0.2}, vsBonus:{infantry:1.5,cavalry:1.2,ranged:1.6,siege:0.7},  description:'La carga que rompe líneas.',buildTurns:3,requires:['standing_army']},
  arqueros:          {name:'Arqueros',          icon:'🏹',category:'ranged',          cost:{gold:50,wood:20},       upkeep:0.4,strength:22, count:35,terrainBonus:{plains:1.0,hills:1.3,forest:1.1,mountains:1.4}, vsBonus:{infantry:1.2,cavalry:0.9,ranged:1.0,siege:0.6},  description:'Fuego a distancia desde posición elevada.',buildTurns:1},
...
// ============================================================
const TRADE_ROUTES = {
  basico:           {name:'Acuerdo Básico',        icon:'🤝',cost:{gold:50},        requires:{relation:15},          income:{gold:20},             duration:'permanent',relationBonus:+1,description:'Intercambio básico de bienes.'},
  ruta_seda:        {name:'Ruta de la Seda',       icon:'🐪',cost:{gold:150,wood:50},requires:{relation:30},          income:{gold:45,morale:+3},   duration:'permanent',relationBonus:+2,description:'Productos de lujo. Mejora la moral.'},
  comercio_hierro:  {name:'Comercio de Armas',     icon:'⚔', cost:{gold:100,iron:30},requires:{relation:20},          income:{gold:35,iron:10},     duration:'permanent',relationBonus:+1,description:'Venta y compra de armas.'},
  intercambio_grano:{name:'Intercambio de Grano',  icon:'🌾',cost:{gold:80},         requires:{relation:10},          income:{food:60,gold:-10},    duration:'permanent',relationBonus:+2,description:'Vital en sequías.'},
  alianza_economica:{name:'Alianza Económica',     icon:'💎',cost:{gold:300},         requires:{relation:60,alliance:true},income:{gold:80,morale:+5,stability:+3},duration:'permanent',relationBonus:+3,description:'Solo con aliados firmes.'}
};
...
// ============================================================
const EVENT_POOL = [
  {id:'trade_caravan',    category:'ECONOMÍA',  priority:'normal',  icon:'🐪',title:'Caravana Mercante',        description:'Una caravana solicita establecer una ruta comercial permanente.',context:'Potencial: +30 oro/turno | Riesgo: espionaje | Coste: 80 madera',condition:(s)=>s.turn>2,weight:8,
    options:[
  ...
  {id:'plague',           category:'CRISIS',    priority:'critical',icon:'☣',title:'Epidemia',                   description:'Una enfermedad desconocida se propaga. La mortalidad crece.',context:'Sin intervención: -20% población en 5 turnos',condition:(s)=>s.turn>8&&Math.random()<0.10,weight:10,
    options:[
  ...
  {id:'alliance_offer',   category:'DIPLOMACIA',priority:'normal',  icon:'🤝',title:'Oferta de Alianza',         description:'Una nación vecina propone alianza con mutua defensa.',context:'Ejército medio | Economía estable | Conflicto latente al este',condition:(s)=>s.turn>3,weight:7,
    options:[
  ...
  {id:'border_raid',      category:'MILITAR',   priority:'high',    icon:'🔥',title:'Incursión Fronteriza',      description:'Guerreros de una tribu saquearon tres aldeas. 200 civiles muertos.',context:'Tribu: ~600 guerreros | Frontera débil | La estación afecta la campaña',condition:(s)=>s.turn>4,weight:9,
    options:[
...
const WIN_CONDITIONS = [
  {id:'domination', name:'Dominio',             description:'Controla el 85% del territorio de Althoria',         check:(s)=>s.territories>=14},
